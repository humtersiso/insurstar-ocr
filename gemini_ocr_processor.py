...
class GeminiOCRProcessor:
    ...
    def extract_insurance_data_with_gemini(self, image_path: str, file_id: str = None) -> Dict:
        ...
        try:
            ...
            === 被保險人區塊 ===
            - 被保險人 (insured_person)
            - 出生日期 (birth_date) - 請仔細尋找，通常在關係欄位附近
            - 性別 (gender) - 男/女，請仔細尋找

            === 要保人區塊 ===
            - 要保人 (policyholder)
            - 與被保險人關係 (relationship)
            - 出生日期 (policyholder_birth_date) - 請仔細尋找
            - 性別 (policyholder_gender) - 男/女，請仔細尋找
            ...
            【範例輸出格式】
            {
                ...
                "policyholder_id": "A123301681",
                "policyholder_birth_date": "民國066年02月06日",
                "vehicle_type": "15/計程車",
                "license_number": "TDX-6172",
                "coverage_items": [
                    {
                        "保險代號": "31",
                        "保險種類": "第三人傷害責任險",
            ...
            請以 JSON 格式輸出結果，特別確保出生日期和性別欄位的準確性。
            """
